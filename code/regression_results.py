...
X_path_options = ['X_train_over', 'X_train_norm', 'X_train_select', 'X_train_over_select', 'X_train', 'X_train_orig', 'X_train_over_orig'] # whether to use overlapping features or full-set features

X_path_mapping = {'X_train_over':'Overlapping', 'X_train':'All', 'X_train_orig':'orig_ALL', 'X_train_over_orig':'orig_Overlapping', 'X_train_select':'All_RFE', 'X_train_over_select':'Overlapping_RFE'}
