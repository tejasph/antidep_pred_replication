...
Example usages
    ...
    Basic:
        python canbind_data_processor_ygen.py /path/to/data/folders
        ...
        if "QIDS_RESP_WK8" in row:
            if np.isnan(row["QIDS_RESP_WK8"]):
                ...
                if week2_qids_sr <= baseline_qids_sr*0.50 or week8_qids_sr <= baseline_qids_sr*0.50:
                    merged_df.set_value(i, 'QIDS_RESP_WK8', 1)
                else:
                    merged_df.set_value(i, 'QIDS_RESP_WK8', 0)
